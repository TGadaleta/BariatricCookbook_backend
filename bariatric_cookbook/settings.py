"""
Django settings for bariatric_cookbook project.
...
SECRET_KEY = 'django-insecure-0d_a%lpr-8c8((ic=dsv58s02u3d5kxzz*^4yhs5or0nq4i5=x'
...
WSGI_APPLICATION = 'bariatric_cookbook.wsgi.application'
